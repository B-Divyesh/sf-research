...
- `one-sitting-idle` — A story-led idle game designed to end in one sitting is a refreshing alternative to the genre’s endless treadmill.
...
- `takeout-photo-metadata-fixer` — Google Photos sidecars are a real archive trap; restoring their dates and places fixes a migration failure people discover too late.
...
- `dyslexia-reading-resume` — “Stop reading” opens with the interruption, not the benefit. Name the saved sentence and resume action before the supporting copy.
